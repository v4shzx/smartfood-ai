...
export const T = {
  es: {
    ...
    dashboard: {
      ...
      op_title: "Operación",
      pos: "Punto de Venta",
      pos_subtitle: "Crea ventas rápido: productos, carrito, descuento y pago.",
      ...
      critical_level: "está en nivel crítico",
      one_min_ago: "Hace 1 min",
      ...
      success_sale: "Venta Exitosa",
      ticket_title: "Ticket",
      smartfood_subtitle: "Comedor Escolar Inteligente",
  ...
  en: {
    ...
    dashboard: {
      ...
      op_title: "Operations",
      pos: "Point of Sale",
      pos_subtitle: "Create sales fast: products, cart, discount, and payment.",
      ...
      critical_level: "is at critical level",
      ...
      success_sale: "Successful Sale",
      ticket_title: "Ticket",
      smartfood_subtitle: "Smart School Dining",
  ...
  fr: {
    ...
    dashboard: {
      ...
      op_title: "Opérations",
      pos: "Point de Vente",
      pos_subtitle: "Créez des ventes rapidement : produits, panier, remise et paiement.",
      ...
      critical_level: "est au niveau critique",
      one_min_ago: "Il y a 1 min",
      ...
      success_sale: "Vente Réussie",
      ticket_title: "Ticket",
      smartfood_subtitle: "Cantine Scolaire Intelligente",
